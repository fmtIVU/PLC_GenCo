...
namespace PLC_GenCo.Generator
{
    public class Data
    {
        ...
        const string forceDataDO = "00 00 00 00 00 00 00 00";
        ...
        const string dataAIx4 = "52 00 00 00 7B 00 00 00 01 00 00 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 01 64 00 00 00";
        ...
        const string dataAIx8 = "9A 00 00 00 7B 00 00 00 01 00 00 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 00 CD 0C FF 3F 00 00 29 0C A3 40 33 0B 99 41 03 00 01 01 64 00 00 00";
